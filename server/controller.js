module.exports = {
    ...
    getFortune: (req, res) => {
        const fortune = ['A beautiful, smart, and loving person will be coming into your life.','A hunch is creativity trying to tell you something.', 'A new perspective will come with the new year.','Any day above ground is a good day.']
